...
\includepdf[width=\paperwidth, height=\paperheight]{/home/sm/Documents/Weddding-Invitation/test2.pdf}

\begin{tikzpicture}[overlay,remember picture]
  \node[anchor=east,inner sep=0pt] (pic) at (current page.east)
    {\includegraphics[width=\paperwidth,height=\pdfpageheight]{map_satellite}};
