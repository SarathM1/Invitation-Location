...
\begin{itemize}
	\item[] {\normalsize \pin} \href{https://goo.gl/maps/qc7ZwHpU8LH2}{From Ernakulam}
	\item[] {\normalsize \pin} \href{https://goo.gl/maps/7gzYJRVjWjG2}{From Aluva}
	\item[] {\normalsize \pin} \href{https://goo.gl/maps/YF2CGPkxyDs}{From Kodungallur}
\end{itemize}
\end{document}